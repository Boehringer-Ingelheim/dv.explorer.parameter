# nolint start
test_that("function is applied per parameter and group. Default quantile calculation algorithm." |>
  vdoc[["add_spec"]](
    c(
...
test_that("function is applied per parameter and group. No grouping. Default quantile calculation algorithm." |>
  vdoc[["add_spec"]](
    c(
      specs$roc$outputs$raincloud$facets,
      specs$roc$outputs$raincloud$axis,
...
test_that("function is applied per parameter and group. No grouping. Default quantile calculation algorithm." |>
 ...
 ds <- tibble::tibble(
  ...
  p1_A <- tibble::tibble(
    ...
    !!CNT_ROC$RVAL := factor(c("A")),
    mean = mean(d_p1_A),
    q05 = unname(stats::quantile(d_p1_A, probs = .05, type = 2)),
    q25 = unname(stats::quantile(d_p1_A, probs = .25, type = 2)),
    q50 = unname(stats::quantile(d_p1_A, probs = .50, type = 2)),
    q75 = unname(stats::quantile(d_p1_A, probs = .75, type = 2)),
    q95 = unname(stats::quantile(d_p1_A, probs = .95, type = 2))
  )
  ...
  p1_B <- tibble::tibble(
    ...
    !!CNT_ROC$RVAL := factor(c("B")),
    mean = mean(d_p1_B),
    q05 = unname(stats::quantile(d_p1_B, probs = .05, type = 2)),
    q25 = unname(stats::quantile(d_p1_B, probs = .25, type = 2)),
    q50 = unname(stats::quantile(d_p1_B, probs = .50, type = 2)),
    q75 = unname(stats::quantile(d_p1_B, probs = .75, type = 2)),
    q95 = unname(stats::quantile(d_p1_B, probs = .95, type = 2))
  )
  ...
  p3_A <- tibble::tibble(
    ...
    !!CNT_ROC$RVAL := factor(c("A")),
    mean = mean(d_p3_A),
    q05 = unname(stats::quantile(d_p3_A, probs = .05, type = 2)),
    q25 = unname(stats::quantile(d_p3_A, probs = .25, type = 2)),
    q50 = unname(stats::quantile(d_p3_A, probs = .50, type = 2)),
    q75 = unname(stats::quantile(d_p3_A, probs = .75, type = 2)),
    q95 = unname(stats::quantile(d_p3_A, probs = .95, type = 2))
  )
  ...
  p3_B <- tibble::tibble(
    ...
    mean = mean(d_p3_B),
    !!CNT_ROC$RVAL := factor(c("B")),
    q05 = unname(stats::quantile(d_p3_B, probs = .05, type = 2)),
    q25 = unname(stats::quantile(d_p3_B, probs = .25, type = 2)),
    q50 = unname(stats::quantile(d_p3_B, probs = .50, type = 2)),
    q75 = unname(stats::quantile(d_p3_B, probs = .75, type = 2)),
    q95 = unname(stats::quantile(d_p3_B, probs = .95, type = 2))
  )
  ...
  get_quantile_data(ds, quantile_type = 2
  ) %>%
    expect_identical(
      expected_ds
    )
