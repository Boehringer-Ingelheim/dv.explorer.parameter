...
test_that("scatterplotmatrix_server prints message for 0 rows group_dataset", {
...
test_that("scatterplotmatrix_server prints message for 0 rows bm_dataset", {
  data <- test_data(anlfl_flags = FALSE)
