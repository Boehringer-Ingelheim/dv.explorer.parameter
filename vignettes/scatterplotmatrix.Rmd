...
![](../man/figures/mod_scatterplotmatrix.png)
...
`dv.biomarker.general::mod_scatterplotmatrix()`
...
Refer to `dv.biomarker.general::mod_scatterplotmatrix()` for the complete list of arguments and their description.
...
dv.manager::run_app(
  ...
  module_list = list(
    "Scatterplot Matrix" = dv.biomarker.general::mod_scatterplotmatrix(
      "scatterplotmatrix",
