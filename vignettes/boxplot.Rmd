...
`dv.biomarker.general::mod_boxplot()`
...
Refer to `dv.biomarker.general::mod_boxplot()` for the complete list of arguments and their description.
...
dv.manager::run_app(
  ...
  module_list = list(
    Boxplot = dv.biomarker.general::mod_boxplot(
      "boxplot",
