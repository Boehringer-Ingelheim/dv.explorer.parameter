...
lb <- data.frame(
  USUBJID = c("1015", "1015", "1015", "1028", "1028", "1028") |> as.factor(),
...
module_list <- list(
  lineplot = dv.explorer.parameter::mod_lineplot(
    ...
    subjid_var = "USUBJID", cat_var = "PARCAT1", par_var = "PARAM", value_vars = "AVAL",
...
dv.explorer.parameter::mod_lineplot(
  module_id = "lineplot", bm_dataset_name = "lb", group_dataset_name = "sl",
  subjid_var = "USUBJID", cat_var = "PARCAT1", par_var = "PARAM", 
