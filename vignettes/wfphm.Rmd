...
![](images/wf_value_param.png){width="75%"}
...
![](images/wf_grouping_param.png){width="75%"}
...
The download chart menu allows to save a configuration of visualisations to your local environment, as a .png or .svg file. 
