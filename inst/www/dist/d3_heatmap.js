...
let hm_chart = function (Shiny, 
//@ts-ignore
d3, r2d3, data, svg, width, height, options, _theme, _console) {
    [];
    // CONSTANTS ===========================================================
    ...
    const is_categorical = function (x) {
    ...
    const onRenderCallback = function (data, _svg, t_width, t_height, options) {
        ...
        labels
            ...
            .attr("font-size", Math.min(C.TILE.LABEL.MAX_SIZE, x_scale.bandwidth() * C.TILE.LABEL.PADDING_PERC))
            .attr("transform", function (d) {
            let x_trans = x_scale(d.x) +
                x_scale.bandwidth() -
