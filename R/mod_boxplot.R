...
check_mod_boxplot <- function(
  ...
  # X-axis resolution
  x_axis_source <- "user" # TODO(miguel): What's the purpose of this (unused variable)
  ...
  if (using_new_api) {
    ...
    #ahwopu # FIXME(miguel)? checks OK[["visit_var"]] and then iterates over `x_axis_vars` and not over `visit_var`
