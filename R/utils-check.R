...
check_unique_sub_cat_par_vis_ <- function(datasets, ds_name, ds_value, sub, cat, par, vis, anlfl, err) {
    ok <- TRUE
...
check_unique_sub_cat_par_vis <- function(datasets, ds_name, ds_value, sub, cat, par, vis, anlfl_vars, err) {
