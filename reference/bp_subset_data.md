...
|              |             |         |              |             |              |
|--------------|-------------|---------|--------------|-------------|--------------|
| `subject_id` | `parameter` | `value` | `main_group` | `sub_group` | `page_group` |
| xx           | xx          | xx      | xx           | xx          | xx           |
...
- `group_vect` names are a subset of main_group, sub_group and
  page_group or empty, otherwise a regular error is produced.
